...
import com.xiaoxiaojiayuan.fsd.constants.WeatherConstants;
...
public class WProfile {
    ...
    public void parseMetar(String[] array, int count) {
        int index = 0;
        String station;
    ...
    public void loadArray(String[] array, int count) {
        int x;
        int index = 0;
    ...
    public WProfile getWProfile(String name) {
    ...
    public void fix(double lat, double lon) {
        ...
        winds.get(3).setSpeed((int) Math.round(Math.abs(Math.sin(a1 * Math.PI / 180.0f)) * maxVelocity));
        ...
        if (a1 > 0) {
            winds.get(2).setDirection((int) Math.round(6 * a1 + latVar + a2 - coriolisVar));
        } else {
            winds.get(2).setDirection((int) Math.round(-6 * a1 + latVar + a2 - coriolisVar));
        }
        ...
        if (a1 > 0) {
            winds.get(1).setDirection((int) Math.round(6 * a1 + latVar + a2 - coriolisVarLow));
        } else {
            winds.get(1).setDirection((int) Math.round(-6 * a1 + latVar + a2 - coriolisVar));
        }
